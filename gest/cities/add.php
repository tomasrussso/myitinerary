...
<head>
  ...
  <title>MyItinerary Gest | Nova Cidade</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="<?= BO_URL ?>/source/cities/add.php" method="post">
      <div class="row">
        <div class="col-12">
          ...
          <div class="card card-primary">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="district" id="inputName2" class="form-control" required>
              </div>
